...
@lists_resource.route('/rest/lists/<list_id>', methods=['GET'])
def get(list_id):
...
@lists_resource.route('/rest/lists/<list_id>', methods=['PUT'])
def put(list_id):
    return Response('{"error":"Not implemented", "id": %s}' % list_id, status=501, mimetype='application/json')


@lists_resource.route('/rest/lists/<list_id>', methods=['DELETE'])
def delete(list_id):
    return Response('{"error":"Not implemented", "id": %s}' % list_id, status=501, mimetype='application/json')
